  ...
  <div class="page">
    ...
    <template v-if="!isLoading && userData">
      <UserInfor
        ...
        :create-days="userData.createDays"
        :event-count="userData.eventCount"
        :followeds="userData.followeds"
        :gender="userData.gender ? true : false"
        ...
        <n-button
          ...
          :type="userData.followed ? 'primary' : ''">
          {{ followFormat }}
        </n-button>
      </UserInfor>
      <UserPlaylist
...
async function getUserData(id: number) {
  ...
  try {
    ...
    messagebox("此用户id不存在，是否依据此id前往歌手页面? 🧐")
      .then(() => {
